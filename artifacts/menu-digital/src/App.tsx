...
const menuData = {
  entradas: [
    { id: 1, nombre: "Bruschetta", desc: "Pan gratinado con Salsa Napoli + Pesto + Queso Mozzarella", precio: 2.75 },
    { id: 2, nombre: "Caldo de Res con Pasta", desc: "Pasta en Beodo", precio: 3 },
    { id: 3, nombre: "Carpaccio de res", desc: "Finas Lonjas de Carne + Aderezo + Aceite de Oliva + Queso", precio: 7.5 },
    { id: 4, nombre: "Crema de Auyama", desc: "Con extra de queso US$ 5.00", precio: 3.5, nota: "extra queso +$5" },
    { id: 5, nombre: "Ensalada Capresssa", desc: "Tomates + Mozzarella + Pesto de Albahaca", precio: 6.5 },
    ...
    { id: 9, nombre: "Minestrone Regular", desc: "Frijol Bayo + Tocineta + Chorizo Español + Vegetales", precio: 5.5 },
    { id: 10, nombre: "Pan con Ajo", desc: "", precio: 1.5 },
  ],
  proteinas: [
    { id: 11, nombre: "Asado Negro", desc: "Nuestro Tradicional y Delicioso Asado Negro", precio: 7.75 },
    ...
    { id: 16, nombre: "Salchicha italiana", desc: "Carne de cerdo y res + semillas de hinojo + ajo y perejil", precio: 5.5 },
  ],
  pastasSalsasRojas: [
    { id: 17, nombre: "Amatriciana", desc: "Ajo + Tocineta + Cebolla + Tomates + Albahaca", precio: 12 },
    { id: 18, nombre: "Bolona", desc: "Ajo + Tocineta + Cebolla + Carne + Tomates + Albahaca", precio: 9.5 },
    { id: 19, nombre: "Filetto", desc: "Aceite de Oliva + Ajo + Albahaca + Tomate al Fuetto", precio: 9 },
    { id: 20, nombre: "Putanesca", desc: "Ajo + Cebolla + Tomates + Albahacas + Aceitunas negras", precio: 10.25 },
  ...
  pastasSalsasBlancas: [
    ...
    { id: 25, nombre: "Pasta al Pesto de Albahaca", desc: "Preguntar Disponibilidad", precio: 12.5, disponibilidad: true },
  ],
  otras: [
    { id: 26, nombre: "Pasta con Asado Negro Tradicional", desc: "", precio: null },
    { id: 27, nombre: "Pasta con Camarones al Ajillo", desc: "Camarones + Mantequilla + Ajo + Perejil", precio: 17.5 },
  ],
  pastas: [
  ...
  menuEjecutivo: [
    ...
    { id: 38, nombre: "Menú Ejecutivo 3", desc: "Caldo o crema del día + Pasta larga tipo Fetuccini + Salsa Carbonara: Tamaño Regular + Refresco y pan de la casa", precio: 10.75 },
  ],
  platosRegulares: [
    ...
    { id: 41, nombre: "Pasta larga tipo Fetuccini + Salsa Carbonara", desc: "", precio: 2.75 },
    { id: 42, nombre: "Arroz con Asado Negro", desc: "", precio: null },
  ],
  bebidas: [
    { id: 43, nombre: "Agua Mineral 600 Ml", precio: 1.5 },
    ...
    { id: 48, nombre: "Refresco de 1.5 Litros", precio: 3.5 },
    { id: 49, nombre: "Refresco de 2 Litros", precio: 3.5 },
    { id: 50, nombre: "Jugo Yukery / Lipton / Gatorade 500 Ml", precio: 3 },
    { id: 51, nombre: "Lipton de 1.5 litros", precio: 7 },
    { id: 52, nombre: "Jugos Naturales (Presa / Piña / Parchita / Lechoza)", precio: 2.5 },
    { id: 53, nombre: "Café pequeño", precio: 1 },
    { id: 54, nombre: "Café grande", precio: 2 },
  ],
  cafe: [
    { id: 55, nombre: "Capuccino", desc: "Café con leche o marrón - grande", precio: 3.5 },
    { id: 56, nombre: "Moccacino", desc: "Café + leche + Cacao - grande", precio: 3.5 },
    { id: 57, nombre: "Latte Vanilla", desc: "Café + leche + Esencia de Vainilla - grande", precio: 3.5 },
    { id: 58, nombre: "Café de la casa", desc: "Café + leche + Amaretto o Ron de Naranja - grande", precio: 4 },
    { id: 59, nombre: "Mouse de Chocolate", precio: 4.5 },
  ],
  postres: [
    { id: 60, nombre: "Torta Corta", precio: 3.5 },
    { id: 61, nombre: "Tiramisú", precio: 4 },
  ],
  pizzas: [
    { id: 62, nombre: "Margarita", desc: "Tomate + Queso", precio: 5.5 },
    ...
    { id: 66, nombre: "Milenium", desc: "Margarita + Ruedas de Tomates Frescos + Albahaca + A. de Oliva", precio: 9.5 },
    { id: 67, nombre: "Napolitana", desc: "Margarita + Anchoa", precio: 9 },
    { id: 68, nombre: "Pepperoni", desc: "Margarita + Pepperoni", precio: 8.5 },
    { id: 69, nombre: "Prosciutto", desc: "Margarita + prosciutto + champiñones", precio: 13.5 },
    { id: 70, nombre: "Salchichón", desc: "Margarita + salchichón + aceitunas negras + pimentón", precio: 12 },
    { id: 71, nombre: "Stefanelli", desc: "Margarita + pepperoni + aceitunas negras + maíz + anchoas + jamón", precio: 14.75 },
  ...
  extras: [
    ...
    { id: 74, nombre: "Extra de Aceitunas Negras", precio: 1.25 },
    { id: 75, nombre: "Extra de Anchoaa", precio: 3.5 },
    { id: 76, nombre: "Extra de Cebolla", precio: 0.25 },
    { id: 77, nombre: "Extra de Champiñones", precio: 2 },
    { id: 78, nombre: "Extra de Chorizo español", precio: 5 },
    { id: 79, nombre: "Extra de Jamón", precio: 1.5 },
    { id: 80, nombre: "Extra de Maíz", precio: 1.5 },
    { id: 81, nombre: "Extra de Mantequilla", precio: 0.5 },
    { id: 82, nombre: "Extra de Pepperoni", precio: 3 },
    { id: 83, nombre: "Extra de Pimentón", precio: 0.25 },
    { id: 84, nombre: "Extra de Prosciutto", precio: 5 },
    { id: 85, nombre: "Extra de Queso Mozzarella", precio: 2.75 },
    { id: 86, nombre: "Extra de Queso Pecorino", precio: 1.75 },
    { id: 87, nombre: "Extra de Salchichón", precio: 5 },
    { id: 88, nombre: "Extra de Tocineta", precio: 3 },
    { id: 89, nombre: "Extra de Tocineta Crocante", precio: 3.25 },
    ...
    <div className="menu-item">
      ...
      <div className="item-precio">
        {item.precio === null
          ...
          : item.precio === 0
          ? "Incluido"
          : `$${item.precio % 1 === 0 ? item.precio.toFixed(0) : item.precio.toFixed(2)}`}
      </div>
    </div>
  );
}
